...
import com.my.baselib.lib.utils.BuildUtils;
...
public class BubbleSeekBar extends View {
    ...
    @IntDef({TextPosition.SIDES, TextPosition.BOTTOM})
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                context.getResources().getColor(R.color.base_orange));
        ...
        if (pos == 0) {
            mTextPosition = TextPosition.SIDES;
        } else if (pos == 1) {
