...
public class GlideCacheUtils {
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(UIUtils.getContext().getCacheDir() + "/" + GlideCatchConfig.GLIDE_CARCH_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public boolean cleanCatchDisk() {
        return deleteFolderFile(UIUtils.getContext().getCacheDir() + "/" + GlideCatchConfig.GLIDE_CARCH_DIR, true);
    }
