...
import com.my.baselib.lib.view.addressselector.util.ResUtils;


public class BottomSelectorDialog extends Dialog {

    private static BottomSelectorDialog dialog;
    ...
    public static BottomSelectorDialog show(Context context, OnAddressSelectedListener listener) {
        dialog = new BottomSelectorDialog(context, R.style.bottom_dialog);
